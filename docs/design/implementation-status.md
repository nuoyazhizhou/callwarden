...
> 最后更新：2026-07-03 · Schema v14 · 23 Mixin · 120 MCP 工具 · 16 语言

本文档是 code_graph 当前能力的权威盘点，对照 [Guardian 规格](evolve-guardian-architecture/spec.md) + [战略分析](competition-analysis.md) + 实际代码逐项核查。历史盘点请参阅 [history/implementation-snapshot-v13.md](../history/implementation-snapshot-v13.md)。
...
| Schema 版本 | v14 | v3→v14 版本化迁移，事务化执行 |
| Mixin 模块 | 23 | CodeGraphBase + 22 个功能 Mixin |
| MCP 工具 | 120 | FastMCP @mcp.tool() 注册 |
...
| .codegraphignore 项目级规则 | ✅ | load_workspace_ignores |
...
| GitHub Actions workflow | ✅ | `.github/workflows/code_graph.yml` |
