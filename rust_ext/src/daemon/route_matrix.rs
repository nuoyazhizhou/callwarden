...
/// 全部 MCP 工具路由条目（由 gen_route_matrix.py --emit-rust 独占生成，勿手改；
/// marker 之外为手写域）。条目数 = names(T) = names(M)（RP-07 SSOT）。
pub const TOOL_ROUTES: &[ToolRoute] = &[
// BEGIN GENERATED ROUTE ENTRIES (gen_route_matrix.py --emit-rust; DO NOT EDIT)
    ...
    ToolRoute { name: "find_evidence", module: "tools_collab", target_backend: Backend::RustNative, rpc_method: "find_evidence", op_class: OpClass::ReadOnly, batch: "MCP-002", status: "migrated" },
    ToolRoute { name: "get_freshness_status", module: "tools_collab", target_backend: Backend::RustNative, rpc_method: "get_freshness_status", op_class: OpClass::ReadOnly, batch: "MCP-003", status: "migrated" },
    ToolRoute { name: "get_gate_decision", module: "tools_collab", target_backend: Backend::RustNative, rpc_method: "get_gate_decision", op_class: OpClass::ReadOnly, batch: "MCP-004", status: "migrated" },
    ...
    ToolRoute { name: "detect_cycle", module: "tools_p2_graph", target_backend: Backend::RustNative, rpc_method: "detect_cycle", op_class: OpClass::ReadOnly, batch: "MCP-007", status: "migrated" },
    ToolRoute { name: "get_artifact_freshness", module: "tools_p2_graph", target_backend: Backend::RustNative, rpc_method: "get_artifact_freshness", op_class: OpClass::ReadOnly, batch: "MCP-005", status: "migrated" },
    ToolRoute { name: "get_dependency_edges", module: "tools_p2_graph", target_backend: Backend::RustNative, rpc_method: "get_dependency_edges", op_class: OpClass::ReadOnly, batch: "MCP-009", status: "migrated" },
    ToolRoute { name: "get_interface_providers", module: "tools_p2_graph", target_backend: Backend::RustNative, rpc_method: "get_interface_providers", op_class: OpClass::ReadOnly, batch: "MCP-006", status: "migrated" },
    ...
    ToolRoute { name: "validate_revision_dependencies", module: "tools_p2_graph", target_backend: Backend::RustNative, rpc_method: "validate_revision_dependencies", op_class: OpClass::ReadOnly, batch: "MCP-008", status: "migrated" },
    ToolRoute { name: "check_action_identity", module: "tools_p3_identity", target_backend: Backend::RustNative, rpc_method: "check_action_identity", op_class: OpClass::ReadOnly, batch: "MCP-011", status: "migrated" },
    ToolRoute { name: "check_session_separation", module: "tools_p3_identity", target_backend: Backend::RustNative, rpc_method: "check_session_separation", op_class: OpClass::ReadOnly, batch: "MCP-012", status: "migrated" },
    ToolRoute { name: "get_action_identity", module: "tools_p3_identity", target_backend: Backend::RustNative, rpc_method: "get_action_identity", op_class: OpClass::ReadOnly, batch: "MCP-010", status: "migrated" },
    ToolRoute { name: "get_attestation_validity", module: "tools_p3_identity", target_backend: Backend::RustNative, rpc_method: "get_attestation_validity", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "list_attestation_revocations", module: "tools_p3_identity", target_backend: Backend::RustNative, rpc_method: "list_attestation_revocations", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "assignment_show", module: "tools_p4_lease", target_backend: Backend::RustNative, rpc_method: "assignment_show", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "export_module_graph", module: "tools_query", target_backend: Backend::RustNative, rpc_method: "export_module_graph", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "find_issues", module: "tools_query", target_backend: Backend::RustNative, rpc_method: "find_issues", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "get_call_heatmap", module: "tools_query", target_backend: Backend::RustNative, rpc_method: "get_call_heatmap", op_class: OpClass::ReadOnly, batch: "S2", status: "migrated" },
    ...
    ToolRoute { name: "get_comment_coverage", module: "tools_query", target_backend: Backend::RustNative, rpc_method: "get_comment_coverage", op_class: OpClass::ReadOnly, batch: "S2", status: "migrated" },
    ToolRoute { name: "get_comment_from_version", module: "tools_query", target_backend: Backend::RustNative, rpc_method: "get_comment_from_version", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "get_deepest_functions", module: "tools_query", target_backend: Backend::RustNative, rpc_method: "get_deepest_functions", op_class: OpClass::ReadOnly, batch: "S2", status: "migrated" },
    ...
    ToolRoute { name: "get_impact", module: "tools_query", target_backend: Backend::RustNative, rpc_method: "get_impact", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "get_issue_summary", module: "tools_query", target_backend: Backend::RustNative, rpc_method: "get_issue_summary", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "get_orphan_symbols", module: "tools_query", target_backend: Backend::RustNative, rpc_method: "get_orphan_symbols", op_class: OpClass::ReadOnly, batch: "S2", status: "migrated" },
    ToolRoute { name: "get_recent_changes", module: "tools_query", target_backend: Backend::RustNative, rpc_method: "get_recent_changes", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "get_symbol_history", module: "tools_query", target_backend: Backend::RustNative, rpc_method: "get_symbol_history", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "get_test_coverage", module: "tools_query", target_backend: Backend::RustNative, rpc_method: "get_test_coverage", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "get_top_callers", module: "tools_query", target_backend: Backend::RustNative, rpc_method: "get_top_callers", op_class: OpClass::ReadOnly, batch: "S2", status: "migrated" },
    ...
    ToolRoute { name: "get_toolchain", module: "tools_rules", target_backend: Backend::RustNative, rpc_method: "get_toolchain", op_class: OpClass::ReadOnly, batch: "S2", status: "migrated" },
    ToolRoute { name: "get_workspace_toolchains", module: "tools_rules", target_backend: Backend::RustNative, rpc_method: "get_workspace_toolchains", op_class: OpClass::ReadOnly, batch: "S2", status: "migrated" },
    ...
    ToolRoute { name: "list_toolchains", module: "tools_rules", target_backend: Backend::RustNative, rpc_method: "list_toolchains", op_class: OpClass::ReadOnly, batch: "S2", status: "migrated" },
    ...
    ToolRoute { name: "cross_repo_impact", module: "tools_security", target_backend: Backend::RustNative, rpc_method: "cross_repo_impact", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "cross_repo_summary", module: "tools_security", target_backend: Backend::RustNative, rpc_method: "cross_repo_summary", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "find_shared_symbols", module: "tools_security", target_backend: Backend::RustNative, rpc_method: "find_shared_symbols", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "get_applicable_rules", module: "tools_security", target_backend: Backend::RustNative, rpc_method: "get_applicable_rules", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "get_edit_history", module: "tools_security", target_backend: Backend::RustNative, rpc_method: "get_edit_history", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "list_branches", module: "tools_security", target_backend: Backend::RustNative, rpc_method: "list_branches", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "lsp_check_available", module: "tools_security", target_backend: Backend::RustNative, rpc_method: "lsp_check_available", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "lsp_completion", module: "tools_security", target_backend: Backend::RustNative, rpc_method: "lsp_completion", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "lsp_definition", module: "tools_security", target_backend: Backend::RustNative, rpc_method: "lsp_definition", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "lsp_diagnostics", module: "tools_security", target_backend: Backend::RustNative, rpc_method: "lsp_diagnostics", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "lsp_hover", module: "tools_security", target_backend: Backend::RustNative, rpc_method: "lsp_hover", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "lsp_references", module: "tools_security", target_backend: Backend::RustNative, rpc_method: "lsp_references", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "merge_preview", module: "tools_security", target_backend: Backend::RustNative, rpc_method: "merge_preview", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "rule_candidate_list", module: "tools_security", target_backend: Backend::RustNative, rpc_method: "rule_candidate_list", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "rule_list", module: "tools_security", target_backend: Backend::RustNative, rpc_method: "rule_list", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "find_similar_functions", module: "tools_semantic", target_backend: Backend::RustNative, rpc_method: "find_similar_functions", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "get_project_dependencies", module: "tools_semantic", target_backend: Backend::RustNative, rpc_method: "get_project_dependencies", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "get_symbol_commit_history", module: "tools_semantic", target_backend: Backend::RustNative, rpc_method: "get_symbol_commit_history", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "parse_codeowners", module: "tools_semantic", target_backend: Backend::RustNative, rpc_method: "parse_codeowners", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "semantic_search", module: "tools_semantic", target_backend: Backend::RustNative, rpc_method: "semantic_search", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "ask_codebase", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "ask_codebase", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ToolRoute { name: "blast_radius", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "blast_radius", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ...
    ToolRoute { name: "cross_layer_impact", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "cross_layer_impact", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ...
    ToolRoute { name: "defect_learn", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "defect_learn", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ...
    ToolRoute { name: "evolution_frequency", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "evolution_frequency", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ToolRoute { name: "find_uncovered_functions", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "find_uncovered_functions", op_class: OpClass::ReadOnly, batch: "S2", status: "migrated" },
    ...
    ToolRoute { name: "get_clone_aware_impact", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "get_clone_aware_impact", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ...
    ToolRoute { name: "get_ownership_map", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "get_ownership_map", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ToolRoute { name: "get_summary", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "get_summary", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ToolRoute { name: "get_token_savings_report", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "get_token_savings_report", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ToolRoute { name: "get_vulnerability_blast_radius", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "get_vulnerability_blast_radius", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ...
    ToolRoute { name: "guardrail_check_edit", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "guardrail_check_edit", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ToolRoute { name: "guardrail_list_rules", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "guardrail_list_rules", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ToolRoute { name: "guardrail_scan", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "guardrail_scan", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ToolRoute { name: "hotspot_evolution", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "hotspot_evolution", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ...
    ToolRoute { name: "project_brief", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "project_brief", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ...
    ToolRoute { name: "repo_map", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "repo_map", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ToolRoute { name: "review_readiness", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "review_readiness", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ToolRoute { name: "test_impact_selection", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "test_impact_selection", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ToolRoute { name: "who_to_ask", module: "tools_summary", target_backend: Backend::RustNative, rpc_method: "who_to_ask", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3transitionmigrated", status: "transition" },
    ToolRoute { name: "audit_verify_chain", module: "tools_task", target_backend: Backend::RustNative, rpc_method: "audit_verify_chain", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "bootstrap_status", module: "tools_task", target_backend: Backend::RustNative, rpc_method: "bootstrap_status", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "get_clone_group_detail", module: "tools_task", target_backend: Backend::RustNative, rpc_method: "get_clone_group_detail", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "get_symbol_change_tasks", module: "tools_task", target_backend: Backend::RustNative, rpc_method: "get_symbol_change_tasks", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "list_audit_signing_keys", module: "tools_task", target_backend: Backend::RustNative, rpc_method: "list_audit_signing_keys", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "list_clone_groups", module: "tools_task", target_backend: Backend::RustNative, rpc_method: "list_clone_groups", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ToolRoute { name: "list_clones", module: "tools_task", target_backend: Backend::RustNative, rpc_method: "list_clones", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "task_assignment_heartbeat", module: "tools_task", target_backend: Backend::TaskRpc, rpc_method: "task.assignment.heartbeat", op_class: OpClass::ProtectedMutation, batch: "existing-task", status: "stable" },
    ToolRoute { name: "task_assignment_status", module: "tools_task", target_backend: Backend::TaskRpc, rpc_method: "task.assignment.status", op_class: OpClass::ReadOnly, batch: "existing-task", status: "stable" },
    ...
    ToolRoute { name: "task_governance_projection", module: "tools_task", target_backend: Backend::TaskRpc, rpc_method: "task.governance_projection.get", op_class: OpClass::ReadOnly, batch: "existing-task", status: "stable" },
    ...
    ToolRoute { name: "task_plan_template", module: "tools_task", target_backend: Backend::RustNative, rpc_method: "task_plan_template", op_class: OpClass::ReadOnly, batch: "P0-COMPAT-v3", status: "migrated" },
    ...
    ToolRoute { name: "task_get_role_prompt", module: "tools_task_prompt", target_backend: Backend::RustNative, rpc_method: "task.prompt.compile", op_class: OpClass::ReadOnly, batch: "RP-08", status: "migrated" },
    ...
    ToolRoute { name: "refresh_file", module: "tools_workspace", target_backend: Backend::RustNative, rpc_method: "workspace.file.refresh", op_class: OpClass::ProtectedMutation, batch: "T02-fs", status: "migrated" },
...
mod tests {
    ...
    #[test]
    fn test_coverage_is_243() {
        assert_eq!(TOOL_ROUTES.len(), 243);
        assert!(ToolRegistry::validate_coverage(243).is_ok());
    }
    ...
    fn test_list_by_backend() {
        ...
        // P0-COMPAT-v3 收敛完成后 python_compat 域已清零（11 项全部翻转到
        // rust_native），compat 侧不再保留任何工具路由。
    ...
    fn test_meta_tools_length() {
        ...
        assert_eq!(v.as_array().map(|a| a.len()), Some(243));
    }
}
