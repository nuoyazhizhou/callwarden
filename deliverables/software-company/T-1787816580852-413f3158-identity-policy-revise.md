...
> 任务：`T-1787816580852-413f3158`（修复流水线状态迁移与任务进度百分比显示）
> 记录时间：2026-09-08
> 批量修复 run：`5ad121a6`
...
- `task.contract_revise` 追加 revision 2：声明 `identity_policy=role_worker_v1`；`supersedes_contract_hash` = revision 1 hash（`sha256:0e6f7e0ffcdccfb94ae74b5c6fd556d9a0ec51ac8ee149ae024e64c32aa7f1fe`）。
...
- `contract_id` 不变（`TC-T-1787816580852-413f3158`）；append-only 追加，不删历史。
