...
> 任务：`T-1787798421878-4a1626e0`（统一任务生命周期与治理进度可见性）
> 记录时间：2026-09-08
> 批量修复 run：`5ad121a6`
...
- `task.contract_revise` 追加 revision 2：声明 `identity_policy=role_worker_v1`；`supersedes_contract_hash` = revision 1 hash（`sha256:3328a7f45f25931326ee404e32acb2a55145dfd9dd9acaf9b124f64b14eac8e0`）。
...
- `contract_id` 不变（`TC-T-1787798421878-4a1626e0`）；append-only 追加，不删历史。
