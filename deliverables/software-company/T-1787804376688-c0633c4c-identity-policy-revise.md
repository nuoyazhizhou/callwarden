...
> 任务：`T-1787804376688-c0633c4c`（reviewer_blocked 批量修正追踪 (2026-08-27)）
> 记录时间：2026-09-08
> 批量修复 run：`5ad121a6`
...
- `task.contract_revise` 追加 revision 2：声明 `identity_policy=role_worker_v1`；`supersedes_contract_hash` = revision 1 hash（`sha256:deb1219274f390d69ec6f8d57431f300ab2f6501ec7c06d05a5f8462212b1c4d`）。
...
- `contract_id` 不变（`TC-T-1787804376688-c0633c4c`）；append-only 追加，不删历史。
