...
> 任务：`T-1787721165244-93dff614`（CLI task-bound reviewer verdict create entry）
> 记录时间：2026-09-08
> 批量修复 run：`5ad121a6`
...
- `task.contract_revise` 追加 revision 2：声明 `identity_policy=role_worker_v1`；`supersedes_contract_hash` = revision 1 hash（`sha256:8555420a40ed0064f097662dd9a9ba73da9c11124f2bbff74d31f38064e9c9da`）。
...
- `contract_id` 不变（`TC-T-1787721165244-93dff614-r1`）；append-only 追加，不删历史。
