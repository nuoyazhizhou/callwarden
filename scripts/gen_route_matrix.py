...
ROUTE_OVERRIDES: Dict[str, Dict[str, str]] = {
    ...
    "get_comment_from_version": {"rpc_method": "get_comment_from_version", "backend": "rust_native", "op": "READ_ONLY", "batch": "P0-COMPAT-v3", "status": "migrated"},
    ...
    "get_impact": {"rpc_method": "get_impact", "backend": "rust_native", "op": "READ_ONLY", "batch": "P0-COMPAT-v3", "status": "migrated"},
    "get_issue_summary": {"rpc_method": "get_issue_summary", "backend": "rust_native", "op": "READ_ONLY", "batch": "P0-COMPAT-v3", "status": "migrated"},
    ...
    "get_recent_changes": {"rpc_method": "get_recent_changes", "backend": "rust_native", "op": "READ_ONLY", "batch": "P0-COMPAT-v3", "status": "migrated"},
    ...
    "get_symbol_history": {"rpc_method": "get_symbol_history", "backend": "rust_native", "op": "READ_ONLY", "batch": "P0-COMPAT-v3", "status": "migrated"},
    ...
    "get_test_coverage": {"rpc_method": "get_test_coverage", "backend": "rust_native", "op": "READ_ONLY", "batch": "P0-COMPAT-v3", "status": "migrated"},
    ...
    "get_attestation_validity": {"rpc_method": "get_attestation_validity", "backend": "rust_native", "op": "READ_ONLY", "batch": "P0-COMPAT-v3", "status": "migrated"},
    "list_attestation_revocations": {"rpc_method": "list_attestation_revocations", "backend": "rust_native", "op": "READ_ONLY", "batch": "P0-COMPAT-v3", "status": "migrated"},
